defmodule FretboardChartCalculatorWeb.Endpoint do
  use SiteEncrypt.Phoenix.Endpoint, otp_app: :fretboard_chart_calculator
  ...
  @session_options [
    store: :cookie,
    key: "_fretboard_chart_calculator_key",
    signing_salt: "4n2jjsdx",
    same_site: "Lax"
  ]
  ...
  plug Plug.Static,
    at: "/",
    from: :fretboard_chart_calculator,
    gzip: false,
    only: FretboardChartCalculatorWeb.static_paths()
  ...
  plug FretboardChartCalculatorWeb.Router
  ...
  def certification do
    SiteEncrypt.configure(
      ...
      domains: ["calculator.cicuta.ru"],
      emails: ["yuriy.shirokov@gmail.com"],
